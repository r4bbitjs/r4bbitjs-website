...
function HomepageHeader() {
  return (
    <div className="w-full h-[95vh] flex flex-col lg:flex-row lg:pb-20">
      <div className="lg:w-1/2 h-3/5 lg:h-full flex justify-center lg:justify-end 2xl:justify-center items-center">
      ...
      <div className="w-full lg:w-1/2  h-2/5 lg:h-full flex justify-center items-start lg:justify-start lg:items-center">
